...
export interface AgentGraphProfileSnapshot {
  readonly capabilityProfile?: SubagentProfile;
  readonly subagentPreset?: RuntimeSubagentPresetContract;
...
// Pure Graph scheduling and execution references are Core contracts.
