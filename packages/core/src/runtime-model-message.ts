...
import { createToolResultEnvelope, type ToolResultEnvelope } from "./tool-result.js";
import type {
  RuntimeEvent,
...
export function runtimeEventHasModelHistoryEntry<TTranscriptEvent>(
...
export function claimKindForEvent<TTranscriptEvent>(
  event: RuntimeEvent<TTranscriptEvent>,
): RuntimeEventClaimKind | undefined {
 ...
 */
export function projectRuntimeModelMessage<TTranscriptEvent>(
  event: RuntimeEvent<TTranscriptEvent>,
): Message | undefined {
