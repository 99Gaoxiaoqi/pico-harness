import type { RuntimeSubagentPresetContract, SubagentProfile } from "./subagent-profile.js";

export type { RuntimeSubagentPresetContract, SubagentProfile } from "./subagent-profile.js";

export type RuntimeConfiguredSubagentContract = RuntimeSubagentPresetContract & {
...
export interface ConfiguredSubagentCatalogPort {
  list(): Promise<RuntimeConfiguredSubagentContract[]>;
  resolve(id: string): Promise<RuntimeSubagentPresetContract & { readonly modelRouteId: string }>;
}
