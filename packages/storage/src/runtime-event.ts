...
export type RuntimeEvent<TTranscriptEvent = DurableTranscriptEvent> =
  CoreRuntimeEvent<TTranscriptEvent>;
...
import { assertPlanEventData, isPlanEventKind } from "@pico/core";
