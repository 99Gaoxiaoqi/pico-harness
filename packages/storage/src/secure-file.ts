...
/** Ensure a private state directory exists without accepting symlink indirection. */
...
/** Refuse non-regular files and symlinks before reading or publishing private state. */
...
/** Atomically publish private, owner-only state after checking the target is not a symlink. */
...
/** Atomically write a workspace-owned file while rejecting a symlinked target. */
