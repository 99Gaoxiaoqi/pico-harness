import type { LocalCommandResult, SlashCommand } from "./command-contracts.js";
import type { HookifyProposal } from "@pico/pico-host/hooks/hookify/rules";
import type {
  HookManagementItem,
  HookManagementReview,
  HookManagementService,
} from "@pico/pico-host/hooks/management/service";
