...
import { isPartialSlashCommandName, isSlashCommandName } from "@pico/core/slash-parser";
...
export interface InputControllerResult {
  ...
  pendingSuggestion?: PendingSuggestionRequest | undefined;
}
...
function withText(
  ...
  cursor: number,
  options: InputControllerOptions,
  flags: { clearHistoryBrowse?: boolean | undefined } = {},
): InputControllerResult {
...
function withPendingSuggestion(
  ...
  suggestion: { pendingSuggestion?: PendingSuggestionRequest | undefined },
): InputControllerResult {
  return {
    ...result,
    ...(suggestion.pendingSuggestion === undefined
