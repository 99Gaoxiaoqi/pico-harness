...
export interface AskUserDialogProps {
  ...
  readonly selectionState?: { selectedIndex: number } | undefined;
  readonly maxVisibleOptions?: number | undefined;
  readonly maxQuestionLines?: number | undefined;
  readonly renderWidth?: number | undefined;
  readonly showOverflowHint?: boolean | undefined;
  readonly onSelect: (optionId: string) => void;
  /** 自由文本提交（请求声明 freeText 时宿主提供；空 trim 拒绝）。 */
  readonly onSubmitText?: ((text: string) => void) | undefined;
  readonly onCancel: () => void;
}

export interface AskUserDialogRequestOptions {
  readonly priority?: number | undefined;
  readonly onClose?: ((dialogId: string) => void) | undefined;
}
...
export function resolveAskUserDialogKey(
  ...
  options: { readonly freeText?: boolean | undefined } = {},
