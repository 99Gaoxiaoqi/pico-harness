...
import { formatPermissionSessionScope } from "@pico/runtime/session-permission-policy";
import type {
...
export interface InteractiveApprovalPanelProps extends ApprovalPanelProps {
  ...
  onDiffExpandedChange?: ((expanded: boolean) => void) | undefined;
...
interface InteractiveDecisionPanelProps {
  ...
  readonly onDiffExpandedChange?: ((expanded: boolean) => void) | undefined;
  readonly diffExpanded?: boolean | undefined;
  readonly keybindings?: UserKeybindingConfig | undefined;
}
...
export function formatApprovalPanel(
  ...
  options: {
    ...
    maxDiffPreviewLines?: number | undefined;
    selectedIndex?: number | undefined;
    feedback?: string | undefined;
  } = {},
): string {
...
export function resolveApprovalPanelKey(
  ...
  const arrowKey = key as typeof key & {
