...
export interface InputBoxProps {
  ...
  acceptsInput?: ((input: string, key: InputKey) => boolean) | undefined;
  /** 将当前草稿同步给顶层焦点仲裁。 */
  onTextChange?: ((text: string) => void) | undefined;
  /** 将会影响焦点仲裁的输入状态同步给顶层。 */
  onStateChange?: ((snapshot: InputBoxStateSnapshot) => void) | undefined;
  /** Enter 提交回调 */
        ...
        <Box flexWrap="wrap">
          {attachments.map((attachment, index) => (
            <Text
              ...
              {...(attachmentCursor === index ? { backgroundColor: "cyan" } : {})}
            >
