...
export type AgentTimelineItem =
  | { id: string; kind: "thinking"; content?: string | undefined }
...
export interface AgentNavigationItem {
  ...
  mode?: ("explore" | "worker") | undefined;
  completionPolicy?: ("required" | "optional" | "detached") | undefined;
  ...
  lifecycle?: TuiSubagentLifecycle | undefined;
}
