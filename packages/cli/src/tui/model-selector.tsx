...
export interface ModelSelectorProps {
  ...
  state?: ModelSelectorState | undefined;
  maxItems?: number | undefined;
  /** 选择确认回调（3-D 客户端接线；缺省为纯浏览）。 */
  callbacks?: ModelSelectorCallbacks | undefined;
}

export interface ModelSelectorCallbacks {
  onConfirm?: ((model: ModelOption) => void) | undefined;
      ...
      {formatModelSelector(models, { currentModelId, state, maxItems })
        ...
        .map((line, index) => (
          <Text
            ...
            {...optionalTextColor(line.startsWith("  ›") ? "cyan" : undefined)}
            dimColor={
