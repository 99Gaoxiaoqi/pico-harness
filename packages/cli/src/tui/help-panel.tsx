...
export interface HelpPanelCommand {
  ...
  source?: SlashCommandSource | undefined;
...
function measureWorstHelpPanelRows(
  commands: readonly HelpPanelCommand[],
  options: { maxItems: number; maxRows?: number | undefined; width?: number | undefined },
): number {
...
function finalizeHelpPanelLines(
  ...
  options: { width?: number | undefined; maxRows?: number | undefined },
): string {
  const formatted =
