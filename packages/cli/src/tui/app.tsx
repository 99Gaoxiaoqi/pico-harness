...
export interface AppProps {
  ...
  discovery?: unknown | undefined;
  /** Main 与子代理的独立导航投影。 */
  agents?: readonly AgentNavigationItem[] | undefined;
  /** 是否正在运行(idle 时聚焦输入框) */
  running: boolean;
  /** Slash command 候选源 */
  slashCommandSuggestions?: SuggestionSource | undefined;
  /** Slash command 参数候选源 */
  slashArgumentSuggestions?: SlashArgumentSuggestionSource | undefined;
  /** @ 文件候选源 */
  fileMentionSuggestions?: SuggestionSource | undefined;
  /** 当前请求展示的 overlay/modal,由 priority 仲裁出唯一焦点弹窗 */
  dialogRequests?: DialogRequest[] | undefined;
  ...
  onInspectTool?: ((toolCallId: string) => void) | undefined;
  onExit?: (() => void) | undefined;
  onRedraw?: (() => void) | undefined;
  /** User keybinding overrides loaded once at TUI startup. */
  keybindings?: UserKeybindingConfig | undefined;
  /** /rewind 等外部动作请求替换输入草稿。 */
  inputReplacement?: { sequence: number; text: string } | undefined;
  /** 当前终端实际支持的剪贴板图片快捷键提示。 */
  imagePasteShortcutLabel?: string | undefined;
  /** Ctrl+L 经 Ink renderer 输出的过渡空帧，避免绕过帧记账。 */
  redrawBlank?: boolean | undefined;
}
...
export function resolveToolCardToggleKey(
  input: string,
  key: { ctrl?: boolean | undefined; shift?: boolean | undefined; meta?: boolean | undefined },
  canToggle: boolean,
  blocked: boolean,
  keybindings?: UserKeybindingConfig,
): ToolCardAction | null {
