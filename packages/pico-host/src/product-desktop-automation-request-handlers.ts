...
import { mcpToolNameMayBelongToServer } from "./mcp-client-types.js";
import type { CredentialVault } from "./provider/credential-vault.js";
import { resolveAutomationCredentialTarget } from "@pico/runtime/provider/automation-credential";
...
} from "./desktop-automation-request-handlers.js";
import {
  RUNTIME_ERROR_CODES,
  ...
  try {
    return {
      ref: resolveAutomationCredentialTarget({
        ...
        ...(effective.sources[`providers.${providerId}`] === undefined
          ? {}
