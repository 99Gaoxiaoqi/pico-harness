...
export class LocalRuntimeClient implements RuntimeClient {
  ...
  private readonly runtimeHostRootPath: string | undefined;
  private readonly candidateEntrypoint: string | URL | undefined;
  private readonly candidateLauncher:
    | ConnectOrSpawnRuntimeHostInput["candidateLauncher"]
    | undefined;
...
class RuntimeSubscription {
  ...
  private replayCycle: RuntimeReplayCycle | undefined;
...
class KernelRuntimeConnection implements RuntimeTransportConnection {
  private hostConnection: RuntimeHostConnection | undefined;
  private hostRegistration: HostRegistration | undefined;
