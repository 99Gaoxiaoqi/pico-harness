...
export interface BackgroundPolicyDiagnostics {
...
import { isToolSupportedForHost } from "@pico/runtime/tool-surface";
...
export async function prepareBackgroundAutonomousPolicy(input: {
  workDir: string;
  policy: unknown;
  trustStore: BackgroundWorkspaceTrustVerifier;
  hookTrustStore?: HookTrustStore;
  diagnostics?: BackgroundPolicyDiagnostics;
...
export class StrictBackgroundHookRunner {
  ...
  constructor(
    ...
    private readonly diagnostics?: BackgroundPolicyDiagnostics,
  ) {
