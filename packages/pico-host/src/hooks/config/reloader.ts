...
export class HookConfigReloader {
  private current: LoadHookSnapshotResult | undefined;
  private readonly watchers = new Map<string, FSWatcher>();
  private readonly watchTimers = new Set<NodeJS.Timeout>();
  private watchLease: { active: boolean } | undefined;
  private readonly changed = new Set<string>();
  private readonly scheduledFingerprints = new Map<string, string>();
  private timer: ScheduledDeadline | undefined;
  private scheduledDrain: Promise<void> | undefined;
