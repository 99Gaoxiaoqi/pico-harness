...
import { SkillLoader, SkillViewTool, type SkillCatalogLogger } from "./skill-catalog.js";
import { hostShellDialect } from "@pico/runtime/host-shell";
import type { SandboxProfile } from "./process-sandbox/index.js";
import { evaluateWorkspaceToolCall, type WorkspaceSandboxConfig } from "./workspace-sandbox.js";
...
export type ChildAgentToolConstructor = (
  workDir: string,
