...
import { resolvePicoHome, resolvePicoPaths, workspaceIdForPath } from "@pico/pico-host/pico-paths";
import {
  ...
  implements SessionRuntimePersistence, EngineRuntimeWriteGuard
{
   ...
   */
  private store: SqliteRuntimeEventStore | undefined;
  private runtimeInitialization: Promise<RuntimeSessionManifest> | undefined;
  private runtimeOwnership: OwnerLease | undefined;
  private runtimeOwnershipPromise: Promise<OwnerLease> | undefined;
  private runtimeOwnerFence: RuntimeOwnerFence | undefined;
  private runtimeProjectionCursor: SessionCursor | undefined;
  ...
  private persistedSettings: PersistedSessionSettings | undefined;
