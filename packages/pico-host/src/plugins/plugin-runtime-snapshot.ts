...
import type { AgentExternalCatalogSource as HostAgentExternalCatalogSource } from "../agent-catalog.js";
import type { ExternalResourceCatalogSource as CoreExternalResourceCatalogSource } from "@pico/core/resource-catalog";
import type { LspServerConfig } from "../code-intelligence/index.js";
import type { HookConfigSourceSpec } from "../hooks/config.js";
import type { McpConfigSource } from "../mcp-connection-manager.js";
...
type AgentExternalCatalogSource = HostAgentExternalCatalogSource<HookTrustAuthority>;
type ExternalResourceCatalogSource = CoreExternalResourceCatalogSource<HookTrustAuthority>;
