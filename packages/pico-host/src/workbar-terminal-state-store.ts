...
import { quarantineCorruptJson, writeJsonAtomic } from "@pico/storage";
import { resolveHostPicoHome } from "./pico-home.js";
...
export class FileWorkbarTerminalStateStore implements WorkbarTerminalStateStore {
  ...
  constructor(options: FileWorkbarTerminalStateStoreOptions = {}) {
    const picoHome = resolveHostPicoHome(options.picoHome);
