...
import type { ModelCapabilityConfig } from "@pico/core";

export interface UsagePricingProviderConfig {
...
export function usagePricing(
  providers: Readonly<Record<string, UsagePricingProviderConfig>>,
  catalog: readonly UsagePricingCatalogEntry[],
): UsagePrice[] {
