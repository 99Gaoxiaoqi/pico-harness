/** Pico Host lifecycle owner for isolated Git worktree tasks. */
...
export interface WorktreeTaskSnapshot {
  ...
  dirty?: boolean;
  error?: string;
  result?: WorktreeRunnerResult | undefined;
...
export class WorktreeSupervisor {
  ...
  private readonly finalizer: WorktreeTaskFinalizer | undefined;
