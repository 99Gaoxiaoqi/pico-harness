...
export interface SubagentActivityEvent {
  ...
  readonly completionPolicy: "required" | "optional" | "detached";
  readonly childSessionId?: string;
  readonly childWorkspacePath?: string;
  readonly toolCallId?: string;
  readonly durationMs?: number;
  readonly agentName?: string;
  readonly currentAction?: string;
  readonly summary?: string;
  readonly requestedModelRoute?: string;
  readonly resolvedModelRoute?: string;
  readonly thinkingEffort?: string;
  readonly modelSelectionSource?: "ephemeral" | "profile" | "parent";
}

export type SubagentTraceEvent =
  | { readonly activityId: string; readonly traceId: string; readonly type: "thinking" }
  | {
      readonly activityId: string;
...
export interface CanonicalTranscriptToolStart {
