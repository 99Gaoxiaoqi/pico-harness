...
type ApprovalManager = HostApprovalManager<PermissionSessionScope>;
...
export class DesktopInteractionBroker {
  ...
  private readonly approvalExpiryTimers = new Map<string, ScheduledDeadline>();
  ...
  constructor(options: DesktopInteractionBrokerOptions = {}) {
    this.approvalManager =
      options.approvalManager ?? new HostApprovalManager<PermissionSessionScope>(undefined, logger);
