...
import type { PlanHandoffController } from "./plan-handoff.js";
...
export interface PlanToolExecutionContext {
...
/** 提交耐久计划提案，并在成功后锁存当前 Run 的正常 handoff。 */
export class SubmitPlanTool<TContext extends PlanToolExecutionContext> {
...
/** 更新已批准计划的单步执行状态。 */
export class UpdatePlanTool<TContext extends PlanToolExecutionContext> {
  readonly readOnly = false;
  readonly permissionCategory = "bounded_control" as const;
  readonly fileSideEffects = { kind: "none" } as const;
