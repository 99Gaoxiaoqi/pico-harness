...
import { RUNTIME_EVENT_SCHEMA_VERSION, type RuntimeAgentOutputEvent } from "@pico/core";
import type { GraphOperatorActivationContext } from "@pico/core/agent-output-contracts";
import { decodeRuntimeEvent, decodeRuntimeEventJson } from "@pico/storage/runtime-event";
import {
