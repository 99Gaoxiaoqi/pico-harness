...
} from "./tool-result-observation.js";

const TOOL_RESULT_REDACTION_MARKER = "[REDACTED]";

/** Host-provided observability boundary for entry-gate rejections. */
export interface RuntimeToolResultLogger {
...
export function buildRuntimeToolResultInput(
  ...
  logger?: RuntimeToolResultLogger,
): { input: ToolResultEnvelopeInput; envelope: ToolResultEnvelope } {
