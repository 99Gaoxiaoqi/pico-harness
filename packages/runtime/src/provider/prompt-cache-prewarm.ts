import { NOOP_PROVIDER_DIAGNOSTICS, type ProviderDiagnostics } from "./diagnostics.js";
...
export class PromptCachePrewarmCoordinator {
  ...
  constructor(
    ...
    private readonly diagnostics: ProviderDiagnostics = NOOP_PROVIDER_DIAGNOSTICS,
  ) {}
  ...
  static shared(scope: string, diagnostics: ProviderDiagnostics = NOOP_PROVIDER_DIAGNOSTICS): PromptCachePrewarmCoordinator {
    ...
    const created = new PromptCachePrewarmCoordinator(Date.now, diagnostics);
