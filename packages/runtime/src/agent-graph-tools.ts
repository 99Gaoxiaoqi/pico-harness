...
import type { AgentGraphOperator } from "@pico/core/agent-graph-contracts";
...
export type { AgentGraphSupervisorToolPort } from "./agent-graph-tool-port.js";
...
abstract class AgentGraphSupervisorTool {
...
): readonly AgentGraphSupervisorTool[] {
  return [
