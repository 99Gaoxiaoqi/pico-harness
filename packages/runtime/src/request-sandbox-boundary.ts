...
export interface RequestSandboxBoundaryContext {
  readonly signal?: AbortSignal;
}

export type RequestSandboxBoundaryHandler<TContext extends RequestSandboxBoundaryContext> = (
...
/** 将模型的边界扩展请求校验为宿主可处理的稳定调用。 */
export class RequestSandboxBoundaryTool<TContext extends RequestSandboxBoundaryContext> {
  ...
  constructor(private readonly handler?: RequestSandboxBoundaryHandler<TContext>) {}
