...
export const providerPresets: readonly ProviderPreset[] = [
  ...
  },
  {
    id: "opencode",
    name: "OpenCode Zen",
    description: "按量付费的编码模型精选，一次连接即可切换使用",
    category: "plans",
    protocol: "openai",
    baseURL: "https://opencode.ai/zen/v1",
  ...
  },
  {
    ...
    description: "连接兼容 OpenAI Responses 的服务或网关",
    category: "custom",
    protocol: "responses",
    baseURL: "",
    apiKeyEnv: "OPENAI_API_KEY",
  ...
  },
  {
    ...
    name: "火山方舟 Agent Plan（中国站）",
    description: "使用 Agent Plan 专属 Key 和 Responses 接口",
    category: "plans",
    protocol: "responses",
    baseURL: "https://ark.cn-beijing.volces.com/api/plan/v3",
    apiKeyEnv: "VOLCENGINE_AGENT_PLAN_API_KEY",
    models: ["ark-code-latest"],
    docs: "https://console.volcengine.com/ark/agent-plan",
    icon: "volcengine",
  },
  {
    id: "custom-anthropic",
...
/** Restore known model wires when editing a unified connection's selected models. */
export function selectedModelProtocols(
  connection: {
    readonly baseURL: string;
    readonly modelProtocols?: Readonly<Record<string, ProviderProtocol>>;
  },
  models: readonly string[],
): Readonly<Record<string, ProviderProtocol>> | undefined {
  if (!connection.modelProtocols) return undefined;
  const preset = providerPresets.find(
    (entry) =>
      entry.modelProtocols && entry.baseURL === connection.baseURL.trim().replace(/\/+$/u, ""),
  );
  return Object.fromEntries(
    Object.entries({ ...preset?.modelProtocols, ...connection.modelProtocols }).filter(([model]) =>
