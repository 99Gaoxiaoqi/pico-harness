    ...
    items: [
      {
        ...
        contentHash: "preview-memory-item-1",
      ...
      },
      {
        ...
        version: 4,
        content: "同步模块曾使用基于时间戳的冲突策略。",
        kind: "knowledge",
        statementType: "fact",
        temporalType: "undated",
        scopeType: "workspace",
        scopeKey: previewWorkspacePath,
        eventStartedAt: null,
        eventEndedAt: null,
        observedAt: now - 604_800_000,
        lifecycleState: "archived",
        origin: "agent_extracted",
        contentHash: "preview-memory-item-2",
