...
- [Hooks 运行时](architecture/07-hooks.md)
- [多 Agent 共享工作区并发规范](architecture/08-multi-agent-concurrency.md)
- [架构债务修整](architecture/09-architecture-debt-remediation.md)
- [架构质量评估](architecture/10-architecture-quality-assessment.md)
- [ToolResult 事实与 Evidence 投影](architecture/11-tool-result-evidence-projection.md)
