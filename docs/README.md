...
`plans/` 只放正在执行的计划；当前任务见[第二批结构调整](plans/2026-09-08-structure-second-pass.md)。最近完成的调整见 [项目结构调整记录](history/plans/2026-09-08-project-structure-cleanup.md)。已结束计划移入 `history/plans/`，历史未勾选项不自动成为当前待办。
