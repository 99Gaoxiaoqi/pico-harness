import {
  createSessionRuntime as createHostSessionRuntime,
  type SessionRuntime as HostSessionRuntime,
  type SessionRuntimeOptions as HostSessionRuntimeOptions,
} from "@pico/pico-host/session-runtime";
...
export type SessionRuntimeOptions = Omit<
  HostSessionRuntimeOptions<SlashCommand>,
  "hookCommandFactory"
>;
