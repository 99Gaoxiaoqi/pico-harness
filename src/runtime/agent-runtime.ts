import {
  AgentRuntime as HostAgentRuntime,
  executeAgentRuntime as executeHostAgentRuntime,
...
export function executeAgentRuntime(
  options: RunAgentCliOptions,
  host: RunAgentCliDependencies = {},
): Promise<RunAgentCliResult> {
  return executeHostAgentRuntime(options, {
    ...host,
    reporter: host.reporter ?? new TerminalReporter(),
  });
}
