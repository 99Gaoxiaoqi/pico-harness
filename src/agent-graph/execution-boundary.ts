...
/**
 * Legacy Engine-facing entry point. The reusable inheritance policy is owned by
 * Pico Host; this adapter keeps Engine-specific Session types out of that package.
 */
